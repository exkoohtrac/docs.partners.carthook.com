...
| **topic** <br><br><sub><sup>REQUIRED</sup></sub> | `"topic"`: `"checkouts/created"` <br><br> Event that triggers the Webhook. <br><br> Valid values are: <br><br> • `checkouts/created`,`checkouts/updated`,`checkouts/completed` <br><br> • `app/uninstalled` |
